...
knitr::kable(
  descriptives,
  digits = 2,
  col.names = c("Condition", "Mean", "SD", "N", "SE", "t", "95% CI Low", "95% CI High")
)
```
...
> 
I was able to reproduce the results although the confidence interval slightly defers. 

How difficult was it to reproduce your results? 

>
It was easy to reproduce the results as the authors provided the tidy data. 

What aspects made it difficult? What aspects made it easy?

> 
As I mentioned in previous question, the provided tidy data made it easy to reproduce the results. However, I do find the column names are not quite straight forward and a little bit confusing. It's not clear the relationship between numerical values and the actual manipulated conditions.
